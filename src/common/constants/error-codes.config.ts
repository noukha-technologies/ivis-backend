...
export const ERROR_CODES: Record<string, ErrorDetails> = {
  ...
  REFERRAL_CODE_EXISTS: {
    ...
    statusCode: HttpStatus.BAD_REQUEST,
    message:
      'You already have a referral code associated with your account. Please use the existing code or try a different one.',
  },
  SUBSCRIPTION_EXISTS: {
    code: '101',
    statusCode: HttpStatus.BAD_REQUEST,
    message:
      "You already have an active subscription. Referral codes can only be applied if you don't have an active subscription.",
  },
