...
export class CreateAppointmentDto {
  @ApiPropertyOptional({
    description:
      'Unique numeric appointment identifier (auto-generated if omitted)',
    example: 1,
  })
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    description: 'Vehicle owner name (auto-filled from records)',
    example: 'Ahmed Al-Said',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Driver full name (defaults to the owner/customer name)',
    example: 'Ahmed Al Said',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Plate colour (auto-filled from records)',
    example: 'White',
  })
  @IsOptional()
  ...
  @IsDateString(
    {},
    { message: 'appointment_at must be a valid ISO date string' },
  )
  ...
  @ApiPropertyOptional({
    description: 'Sync customer record from ANPR/ROP on create',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Vehicle body type (snapshot, stored lowercase)',
    example: 'sedan',
  })
  @IsOptional()
