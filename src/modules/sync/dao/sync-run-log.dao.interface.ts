import { SyncRunLog, SyncRunStatusValue } from '../../database/entity/sync-run-log.entity';
...
export interface ISyncRunLogDao {
  ...
  recordChunk(id: string, direction: 'pushed' | 'pulled', entityKey: string, count: number): Promise<void>;

  finishRun(id: string, status: SyncRunStatusValue, error?: string | null): Promise<void>;
